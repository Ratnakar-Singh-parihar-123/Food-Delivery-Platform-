...
// const STATIC_BASE = "https://myfoodmitra-ecosystem.onrender.com"; // your server base URL
...
// // ─── Order Detail Modal with Images ──────────────────────────
...
//         let response;
//         if (mode === "live") {
//           response = await getAdminLiveOrders();
//         } else {
//           response = await getAdminOrders({ limit: 50 });
//         }
    ...
    <div className="px-4 py-6 mx-auto space-y-6 max-w-7xl">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-gray-400">
            Monitor and manage all orders across your platform
          </p>
        </div>
        <div className="flex items-center gap-3">
          <div className="flex p-1 bg-white border border-gray-200 shadow-sm rounded-2xl">
            <button
              onClick={() => {
                setViewMode("all");
                fetchOrders("all");
